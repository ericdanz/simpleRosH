...
(cl:defmethod cl:initialize-instance :after ((m <Error>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Error)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_beagle-msg:<Error> is deprecated: use robot_beagle-msg:Error instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_beagle-msg:error-val is deprecated.  Use robot_beagle-msg:error instead.")
  (error m))
