...
(cl:defmethod cl:initialize-instance :after ((m <BootResponse>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BootResponse)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_beagle-msg:<BootResponse> is deprecated: use robot_beagle-msg:BootResponse instead.")))

(cl:ensure-generic-function 'gatenumber-val :lambda-list '(m))
(cl:defmethod gatenumber-val ((m <BootResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_beagle-msg:gatenumber-val is deprecated.  Use robot_beagle-msg:gatenumber instead.")
  (gatenumber m))

(cl:ensure-generic-function 'gatetype-val :lambda-list '(m))
(cl:defmethod gatetype-val ((m <BootResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_beagle-msg:gatetype-val is deprecated.  Use robot_beagle-msg:gatetype instead.")
  (gatetype m))
