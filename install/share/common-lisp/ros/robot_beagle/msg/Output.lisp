...
(cl:defmethod cl:initialize-instance :after ((m <Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_beagle-msg:<Output> is deprecated: use robot_beagle-msg:Output instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <Output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_beagle-msg:output-val is deprecated.  Use robot_beagle-msg:output instead.")
  (output m))
