...
(cl:defmethod cl:initialize-instance :after ((m <Input>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Input)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_beagle-msg:<Input> is deprecated: use robot_beagle-msg:Input instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <Input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_beagle-msg:input-val is deprecated.  Use robot_beagle-msg:input instead.")
  (input m))
