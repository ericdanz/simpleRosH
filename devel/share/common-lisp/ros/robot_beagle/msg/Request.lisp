...
(cl:defmethod cl:initialize-instance :after ((m <Request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_beagle-msg:<Request> is deprecated: use robot_beagle-msg:Request instead.")))

(cl:ensure-generic-function 'request-val :lambda-list '(m))
(cl:defmethod request-val ((m <Request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_beagle-msg:request-val is deprecated.  Use robot_beagle-msg:request instead.")
  (request m))
